...
const condominiumReducerInitialState = {
  sliders: {
    floorArea: {
      start: 0,
      middle: 100,
...
const condominiumReducer = (state = condominiumReducerInitialState, action) => {
  let newState = null;
  let sliderchg = null;
  let searchchg = null;
  let newPos = null;
  ...
  switch (action.type) {
    case cndconstants.CONDOMINIUM_PAYLOAD:
    ...
    case cndconstants.SLIDER_CHANGE_PRICE:
    ...
    case cndconstants.SLIDER_CHANGE_HOUSE_AREA:
      // do our calculations to work out our new positions
      ...
      break;
    case cndconstants.SLIDER_CHANGE_LOT_AREA:
      // do our calculations to work out our new positions
    ...
    case cndconstants.BED_SELECT_CHANGE:
      // Create a new object for the search element, ensuring no mutation
      searchchg = {
    ...
    case cndconstants.BATH_SELECT_CHANGE:
      // Create a new object for the search element, ensuring no mutation
      searchchg = {
        ...state.search, // Shallow copy of price
        bath: {
    ...
    case cndconstants.CAR_SELECT_CHANGE:
      // Create a new object for the search element, ensuring no mutation
      searchchg = {
        ...state.search, // Shallow copy of price
        car: {
    ...
    case cndconstants.SEARCH_CLICK:
      // Create a new object for the search element, ensuring no mutation
